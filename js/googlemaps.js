    ...
    google.maps.event.addListener(marker, 'drag', function(){
		...
		function displayLocationDistance(request, request2, request3){
			...
			if(uzaklikTemelli ==  Math.min(uzaklikTemelli, uzaklikHasanoglan, uzaklikSaray)){
				...
				document.getElementById('fabrikauzaklik').value = uzaklikTemelli;
				...
				document.getElementById('fabrikauzaklik').value = uzaklikHasanoglan;
				...
				document.getElementById('fabrikauzaklik').value = uzaklikSaray;
